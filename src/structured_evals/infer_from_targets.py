...
def infer_structured_evaluator_from_predictions(
    data: Any,
    ...
    if isinstance(data, dict):
        ...
        return DictEval(
            eval_mapping={
                key: infer_structured_evaluator_from_predictions(value, text_evaluator)
        ...
        return ListEval(
            item_evaluator=infer_structured_evaluator_from_predictions(data[0], text_evaluator),
